<?php
/**
 * Medialog Turspor: Color Patterns
 *
 ...
 */
function medialog_turspor_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

	/**
	 * Filter Medialog Turspor default saturation level.
	 *
	 * @since Medialog Turspor 1.0
	 *
	 * @param int $saturation Color saturation level.
	 */
	$saturation = absint( apply_filters( 'medialog_turspor_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.medialog_turspor-front-page) .entry-title,
...
.colors-custom .medialog_turspor-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.medialog_turspor-front-page .panel-content .recent-posts article,
...
.colors-custom.medialog_turspor-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	...
	/**
	 * Filters Medialog Turspor custom colors CSS.
	 *
	 * @since Medialog Turspor 1.0
	 *
	 ...
	 */
	return apply_filters( 'medialog_turspor_custom_colors_css', $css, $hue, $saturation );
}
